  ...
  return (
    <MultiStepFormContext.Provider value={multiStepForm}>
      <form
        ...
        className={cn(className, 'flex size-full flex-col ')}
      >
        {header}
...
export const MultiStepFormStep = React.forwardRef<
  ...
  >
>(function MultiStepFormStep({ children, ...props }, ref) {
  return (
    <div ref={ref} {...props}>
...
export const MultiStepFormHeader = React.forwardRef<
  ...
  >
>(function MultiStepFormHeader({ children, ...props }, ref) {
  return (
    <div ref={ref} {...props}>
      <Slottable>{children}</Slottable>
    </div>
...
export const MultiStepFormFooter = React.forwardRef<
  ...
  >
>(function MultiStepFormFooter({ children, ...props }, ref) {
  return (
    <div ref={ref} {...props}>
      <Slottable>{children}</Slottable>
    </div>
