          ...
          <AlertDialog>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem
                  onClick={() =>
                    (window.location.href = `/admin/trainings/${module.trainingId}/modules/${module.id}/submodules`)
                  }
                >
                ...
                <DropdownMenuItem
                  onClick={() =>
                    (window.location.href = `/admin/trainings/${module.trainingId}/modules/${module.id}/permissions`)
                  }
                >
